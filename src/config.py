...
# GAME CONFIGURATION
# ============================================================
GAME_DATA_DIR = os.environ.get("GAME_DATA_DIR", str(PROJECT_ROOT / "game_data"))
DATABASE_DIR = os.environ.get("DATABASE_DIR", str(PROJECT_ROOT / "database"))
SAVES_DIR = os.environ.get("SAVES_DIR", str(PROJECT_ROOT / "saves"))
